...
| NO   | 이름   | 팀              | Email                | VM Server | VM Server IP  | Namespace | 비고 |
| ---- | ------ | --------------- | -------------------- | --------- | ------------- | --------- | ---- |
...
| 5    | 김용기 | Cloud매니지드팀 | brave.kim@kt.com     | eduVM05   | 4.230.41.87   | user05    | 불참 |
...
| 17   | 임진영 | Cloud수행팀     | jinyoung.lim@kt.com  | eduVM17   | 4.230.26.40   | user17    | 불참 |
